// servicesData.js - Shared compliance databases for MSR Assessment Pvt Ltd
...
export const subData = {
  ...
  inc: [
    ...
    { id: "private-limited-company-registration-india", title: "Private Limited Company Registration in India | Expert Support", desc: "Register a Private Limited Company in India with end-to-end support for name approval, DSC, DIN, incorporation, and MCA compliance. Start your business quickly through a simple online registration process.", time: "7-10 days", icon: "fa-city", isLarge: true },
    { id: "llp-registration-india", title: "LLP Registration in India | Online LLP Registration Services", desc: "Register your LLP in India with expert assistance. Get support for name reservation, partner documentation, MCA filing, and LLP incorporation through a simple online process.", time: "8-12 days", icon: "fa-handshake", isLarge: true },
  ...
  digital: [
    ...
    },
    {
      ...
      desc: "Leading mobile app development company offering custom mobile application development services. Build scalable, secure, and user-friendly apps for business growth.",
      time: "20-30 days",
      expertAssigned: "Full Stack Developer",
    ...
    },
    {
      ...
      desc: "Looking for professional web development services? Get custom, responsive, and SEO-friendly websites designed to drive growth and conversions.",
      time: "10-15 days",
      expertAssigned: "Web Developer",
      icon: "fa-laptop-code",
      isLarge: false,
      eligibility: [],
      documents: [],
    ...
    },
    {
      ...
      desc: "Build a high-performing online store with our E-commerce Web Development services. Get a secure, scalable, and user-friendly website designed to drive sales and business growth.",
      time: "12-18 days",
      expertAssigned: "Web Developer",
    ...
    },
    {
      ...
      desc: "Boost your business with expert SEO and Search Engine Marketing (SEM) services that improve online visibility, drive targeted traffic, increase conversions, and generate high-quality leads.",
      time: "Ongoing",
    ...
    },
    {
      ...
      desc: "Grow your brand with professional Social Media Marketing services. Increase engagement, reach your target audience, generate leads, and drive business growth across leading social platforms.",
      time: "Monthly",
      expertAssigned: "Social Media Manager",
      icon: "fa-share-nodes",
      isLarge: false,
      eligibility: [],
      documents: [],
    ...
    },
    {
      ...
      desc: "Create a memorable brand with professional Brand Identity and Design services. Build recognition, strengthen credibility, and connect with your target audience.",
      time: "5-7 days",
      expertAssigned: "Brand Designer",
  ...
  ip: [
    {
      id: "register-trademark-online",
      title: "Fast Trademark Registration Services | Protect Your Brand",
      desc: "Get fast trademark registration services to protect your brand, logo, and business name. Expert filing support with affordable pricing.",
      time: "Monthly",
      expertAssigned: "IP Attorney",
      icon: "fa-trademark",
      isLarge: true,
      eligibility: [],
      documents: [],
    ...
    { title: "Trademark Renewal", desc: "Filing maintenance documents to renew trademark rights every 10 years.", time: "2-3 days", icon: "fa-rotate", isLarge: false },
    {
      ...
      desc: "Protect your books, music, software, artwork, and digital content with expert copyright registration services and secure legal ownership rights.",
      time: "10-15 days",
      expertAssigned: "IP Attorney",
      icon: "fa-copyright",
      isLarge: false,
    ...
    {
      id: "patent-application-india",
      title: "Patent Filing",
      desc: "Provisional or complete patent specifications filing with IP office.",
      time: "Monthly",
      expertAssigned: "Patent Attorney",
      icon: "fa-lightbulb",
      isLarge: false,
      eligibility: [],
      documents: [],
...
export const articles = [
  {
    ...
    icon: "fa-file-invoice-dollar",
    image: "/msrassessment/assets/premium_corporate_photography_of_four_professional_business_consultants_.jpg",
    date: "June 2026",
    readTime: "5 min read",
  ...
  },
  {
    ...
    icon: "fa-building",
    image: "/msrassessment/assets/elegant_executive_board_room_with_glass_doors_and_professional_seating.png",
    date: "May 2026",
    readTime: "4 min read",
  ...
  },
  {
    ...
    icon: "fa-trademark",
    image: "/msrassessment/assets/high_end_corporate_still_life_photography_of_a_professional_wax_seal_on_a.png",
    date: "April 2026",
    readTime: "3 min read",
  ...
  },
  {
    ...
    tagText: "ISO QMS",
    icon: "fa-award",
    image: "/msrassessment/assets/modern_high_rise_corporate_office_building_with_glass_facade_representing.png",
    date: "March 2026",
    readTime: "6 min read",
  ...
  },
  {
    ...
    tagText: "Taxation",
    icon: "fa-receipt",
    image: "/msrassessment/assets/global_business_map_visualization_with_data_nodes_and_connections_styliz.png",
    date: "February 2026",
    readTime: "4 min read",
  ...
  },
  {
    ...
    tagText: "Tech & Web",
    icon: "fa-laptop-code",
    image: "/msrassessment/assets/two_professional_businessmen_in_suits_shaking_hands_in_a_high_rise_office.png",
    date: "January 2026",
    readTime: "5 min read",
